...
typedef void (* x_playerStatuscbk_func)(char* playerName,char* events,char* msg,unsigned int xt_user);
typedef void (* x_playerTipscbk_func)(unsigned int xt_user,char* tips);
///////////////////////////////////////////////////////////////////////////
// vxRTSPClient
...
public:
	...
	*     成功，返回 0；失败，返回 错误码。
	*/
	//x_int8_t open(const x_string_t xt_rtsp_url, x_realcbk_func xfunc_realcbk,x_pausecbk_func xfunc_pausecbk, x_uint32_t xt_user,x_playerStatuscbk_func xfunc_playerStatus);
...
public:
	...
	x_uint32_t		  m_xt_connectSuccess;			//连接成功标志
	...
	x_playerTipscbk_func m_xfunc_playerTip;	///<打印提示信息接口
